              ...
              <Card className="w-full max-w-2xl mx-auto animate-fade-in">
                <CardContent className="pt-6 space-y-6">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-4">
                    <Button variant="outline" className="flex-1 border-purple-600 text-purple-600 hover:bg-purple-600/10" onClick={handleShare}>
                      Share Results & Join @ieltsvc
                    </Button>
                    
                    <Button className="flex-1 bg-purple-600 hover:bg-purple-700" onClick={handleDownloadCertificate}>
                      Download Certificate
                    </Button>
                  </div>
                  
                  <div className="text-center pt-2">
                    <a href="https://t.me/ieltsvc" target="_blank" rel="noopener noreferrer" className="text-purple-600 hover:underline text-sm">
