...
// More varied questions
{
  ...
  options: [{
    id: "a",
    text: "International agreements have successfully solved the climate crisis"
  }, {
    id: "b",
    text: "Current commitments under the Paris Agreement are likely insufficient to meet climate targets"
  }, {
    id: "c",
    text: "The Kyoto Protocol was more effective than the Paris Agreement"
  }, {
    id: "d",
    text: "Scientific consensus on climate change has decreased over time"
  }],
  difficulty: "C2" // CEFR Level - IELTS 8.5-9.0
}];
...
const QuizIntro = ({
  ...
  return <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="mb-8 p-6 bg-white rounded-lg shadow-md">
        ...
        <div className="mt-6">
          <Button className="bg-brand-gold hover:bg-opacity-90 text-white px-6 py-6 h-auto text-lg" onClick={onStartTest}>
...
const Test = () => {
  ...
  if (!testStarted) {
    ...
    content = <div className="space-y-8">
        ...
        <TestProgressBar currentQuestion={currentQuestionIndex + 1} totalQuestions={sampleQuestions.length} className="mb-8" />
    ...
    content = <div className="space-y-8">
        ...
        {cefrLevel && <div className="space-y-6">
            <Card className="w-full max-w-2xl mx-auto animate-fade-in">
              <CardContent className="pt-6 space-y-6">
                ...
                <div className="flex justify-center items-center mb-6">
                  <div className="relative w-36 h-36">
                    <svg className="w-full h-full" viewBox="0 0 36 36">
                      ...
                      <path d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="#0A3D62" strokeWidth="3" strokeDasharray={`${overallScore}, 100`} className="transition-all duration-1000 ease-in-out" />
                    </svg>
                ...
                {sectionScores && <div className="space-y-3">
                    <h4 className="font-semibold text-center">Section Breakdown</h4>
                    <div className="grid grid-cols-2 gap-3">
                      {sectionScores.map(section => <div key={section.name} className="p-3 border rounded-md">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  <Button variant="outline" className="flex-1 border-brand-blue text-brand-blue hover:bg-brand-blue/10" onClick={handleShare}>
                    Share Results & Join @ieltsvc
                  </Button>
                  
                  <Button className="flex-1 bg-brand-gold hover:bg-opacity-90" onClick={handleDownloadCertificate}>
                    Download Certificate
                  </Button>
                </div>
                
                <div className="text-center pt-2">
                  <a href="https://t.me/ieltsvc" target="_blank" rel="noopener noreferrer" className="text-brand-blue hover:underline text-sm">
