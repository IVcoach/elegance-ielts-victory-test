...
import { Award, TrendingUp, Target, Star, Trophy, Users, Send, Clock, CheckCircle } from "lucide-react";
        ...
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in order-2 lg:order-1">
              ...
              {/* Verification Badge */}
              <div className="bg-white/90 p-4 rounded-lg shadow-md mb-8 border border-gray-200">
                <div className="flex items-center gap-3 mb-2">
                  <CheckCircle className="h-6 w-6 text-green-600" />
                  <span className="font-bold text-gray-900">Officially Verified</span>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <Button onClick={handleTelegramResources} size="lg" className="professional-button-secondary flex items-center gap-2">
                  <Send className="h-5 w-5" />
                  Join @ieltstori Community
                </Button>
                <Button asChild size="lg" variant="outline" className="border-2 border-blue-800 text-blue-800 hover:bg-blue-50 font-bold shadow-md transform hover:scale-105 transition-all">
                  <Link to="/test?practice=true">Speaking & Writing Analysis</Link>
                </Button>
              </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-gradient-to-br from-blue-50 via-white to-gray-50 p-8 rounded-2xl shadow-xl border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="professional-card flex items-center gap-6 transform hover:scale-105 transition-all">
                <Award className="h-12 w-12 text-blue-800 flex-shrink-0" />
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-2xl font-bold text-gray-900">Band 8+</span>
                    <span className="text-xl font-bold text-blue-800">15%</span>
                  </div>
                  <Progress value={15} className="h-4 bg-blue-100" />
                </div>
              </div>
              ...
              <div className="professional-card flex items-center gap-6 transform hover:scale-105 transition-all">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-xl font-bold text-green-700">45%</span>
                  </div>
                  <Progress value={45} className="h-4 bg-green-100" />
                </div>
              </div>
              
              <div className="professional-card flex items-center gap-6 transform hover:scale-105 transition-all">
                <Target className="h-12 w-12 text-purple-700 flex-shrink-0" />
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-2xl font-bold text-gray-900">Band 6.5</span>
                    <span className="text-xl font-bold text-purple-700">30%</span>
                  </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white">
        <div className="container mx-auto max-w-6xl text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            ...
            <Button onClick={handleTelegramResources} size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-gray-900 font-bold shadow-xl transform hover:scale-105 transition-all px-8 py-4">
              Join @ieltstori Community
            </Button>
          </div>
