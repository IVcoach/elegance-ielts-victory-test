  ...
  return <nav className="w-full bg-white bg-opacity-95 backdrop-blur-sm fixed top-0 z-50 border-b shadow-lg">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-4">
          <img src="/lovable-uploads/2b59e768-d5ce-4555-89d3-872a72db7377.png" alt="IELTS Victory Logo" className="h-20 w-auto transform hover:scale-105 transition-transform" />
