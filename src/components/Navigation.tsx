    ...
    <nav className="w-full bg-white bg-opacity-95 backdrop-blur-sm fixed top-0 z-50 border-b shadow-lg">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-4">
          ...
          />
          <span className="font-playfair font-black text-3xl text-transparent bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text">
            V&C Elegance
          </span>
        </Link>
      ...
      <div className={cn(
        ...
        <div className="container mx-auto px-4 py-4 flex flex-col gap-6">
          <Link 
            to="/" 
            className="font-semibold text-lg text-gray-700 hover:text-brand-blue transition-colors py-2"
