...
import { TelegramBotModal } from "./about/TelegramBotModal";

export const SharedFloatingTelegramBot = () => {
  const [showFloatingBot, setShowFloatingBot] = useState(false);
  const [showBotModal, setShowBotModal] = useState(false);

  useEffect(() => {
    const handleScroll = () => {
      // Show floating bot after scrolling 300px
      setShowFloatingBot(window.scrollY > 300);
    };
