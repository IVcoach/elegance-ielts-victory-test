    ...
    <footer className="bg-brand-navy text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-playfair font-bold mb-4 text-brand-gold">V&C Elegance</h3>
          ...
          <div>
            <h4 className="text-lg font-playfair font-semibold mb-4 text-brand-gold">Contact</h4>
            <ul className="space-y-2">
              <li className="text-sm text-gray-300">
                <span className="font-semibold">Email:</span> info@vce-ielts.com
              </li>
              <li className="text-sm text-gray-300">
