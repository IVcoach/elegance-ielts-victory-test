          ...
          <div className="text-center bg-gradient-to-r from-pink-50 via-blue-50 to-purple-50 p-10 rounded-3xl border-3 border-gradient shadow-2xl">
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center justify-center gap-8 mb-6">
                ...
                <a href="https://www.instagram.com/ielts.tory" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border-2 border-pink-200 hover:border-pink-400 transition-all transform hover:scale-110">
