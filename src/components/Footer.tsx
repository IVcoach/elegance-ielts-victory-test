        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col items-center space-y-2 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-400 font-medium text-sm">Cambridge University CERF Certified</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="h-4 w-4 text-green-400" />
                <span className="text-green-400 font-medium text-sm">IDP Education Protocols Verified</span>
              </div>
              <div className="flex items-center gap-2">
                <Award className="h-4 w-4 text-yellow-400" />
                <span className="text-yellow-400 font-medium text-sm">5+ Years Excellence Record</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mb-8">
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 transform hover:scale-105 transition-all">
              ...
              <a href="https://wa.me/+31631267353" target="_blank" rel="noopener noreferrer" className="text-lg text-blue-300 hover:text-blue-200 transition-colors font-medium block">
                +31 631 267 353
              </a>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 transform hover:scale-105 transition-all">
              ...
              <a href="mailto:vcelegance@consultant.com" className="text-lg text-green-300 hover:text-green-200 transition-colors font-medium block">
          ...
          <div className="bg-white/10 backdrop-blur-sm p-4 rounded-lg border border-white/20 max-w-xs mx-auto mb-8">
            ...
            <p className="text-xs text-gray-300">Number: 000061974544</p>
