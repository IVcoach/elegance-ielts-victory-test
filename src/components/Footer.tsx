...
export function Footer() {
  return (
    <footer className="bg-gradient-to-br from-gray-50 via-white to-blue-50 text-gray-900 py-20 border-t border-gray-200 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center bg-gradient-to-r from-pink-50 via-blue-50 to-purple-50 p-10 rounded-3xl border-3 border-gradient shadow-2xl">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border-2 border-green-200 transform hover:scale-105 transition-all">
                  ...
                  <a 
                    ...
                    className="text-green-600 hover:text-green-700 transition-colors font-bold text-xl hover:underline"
                  >
                    +31 631 267 353
                  </a>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border-2 border-blue-200 transform hover:scale-105 transition-all">
                  ...
                  <a 
                    ...
                    className="text-blue-600 hover:text-blue-700 transition-colors font-bold text-xl hover:underline"
                  >
              ...
              <div className="flex items-center justify-center gap-8 mb-6">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group flex items-center gap-3 bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border-2 border-blue-200 hover:border-blue-400 transition-all transform hover:scale-110"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group flex items-center gap-3 bg-white/80 backdrop-blur-sm p-4 rounded-2xl shadow-lg border-2 border-pink-200 hover:border-pink-400 transition-all transform hover:scale-110"
                >
            ...
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl border-2 border-gray-200 mb-6">
              ...
              <p className="text-xl text-gray-800 italic font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
