          ...
          <div className="animate-fade-in order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="mb-8">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight mb-6">
                ...
                <br />
                <span className="text-3xl md:text-4xl lg:text-5xl text-blue-800 bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
            ...
            <p className="text-xl text-gray-700 mb-8 font-medium leading-relaxed max-w-2xl">
            ...
            {/* Verification Badge - Better Alignment */}
            <div className="bg-white/95 p-6 rounded-xl shadow-lg mb-8 border-2 border-green-200 relative overflow-hidden max-w-2xl">
            ...
            {/* Professional Statistics - Improved Grid */}
