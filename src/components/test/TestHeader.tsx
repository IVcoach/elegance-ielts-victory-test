...
export function TestHeader({
  ...
  return <div className="text-center mb-8 bg-white p-6 rounded-xl shadow-md border border-purple-200">
      ...
      <div className="mb-6">
        <Carousel className="w-full max-w-md mx-auto">
          <CarouselContent>
            {assessmentImages.map((image, index) => <CarouselItem key={index}>
      ...
      <Button onClick={onTelegramResources} className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold px-6 py-3 rounded-lg shadow-lg transform hover:scale-105 transition-all flex items-center gap-2">
